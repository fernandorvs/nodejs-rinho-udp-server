...
CREATE TABLE `tracks` (
	...
	`deviceId` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT '',
	`reportType` varchar(2) DEFAULT NULL,
	`reportId` varchar(2) CHARACTER SET utf8 DEFAULT NULL,
	...
	`inputs` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
	`outputs` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
	...
	`txtMessage` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
	`msgNum` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
